...
#
# Scorecard scores a REPOSITORY, not a package, so one score covers every package in
# this repo (duck-error and anything added beside it). There is no per-package score.
set -euo pipefail
