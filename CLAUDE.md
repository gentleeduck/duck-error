...
- **Dependencies**: `packages/duck-error` stays zero-runtime-dependency. Anything framework-specific belongs in `examples/`, never as a dependency of the core package.
