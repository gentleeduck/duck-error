...
description: Install @gentleduck/errors and build your first error kit, from a one-code registry to a typed, secret-safe error class.
---
...
pnpm add @gentleduck/errors
yarn add @gentleduck/errors
```
...
```typescript
// errors.ts
import { createErrorKit } from '@gentleduck/errors'
...
```typescript
import { createErrorKit, detail } from '@gentleduck/errors'
