...
description: @gentleduck/duck-error has zero runtime dependencies and ships both ESM and CJS, so it runs in the browser, edge runtimes, and React Native — with one real gotcha on the client.
---
