...
## Supported Versions
We provide security updates for the latest major release of duck-error.
Older versions may not receive patches.

## Reporting a Vulnerability
**Please do not disclose security issues publicly.**
If you discover a vulnerability in duck-error:
...
Thank you for helping keep duck-error secure.
